...
New to GitHub? → Check out [github-basics.md](https://github.com/chandron/IMBB-rnaseq-workshop-1day/blob/main/github-basics.md](https://github.com/chandron/IMBB-rnaseq-workshop-1day/blob/main/docs/github-basics.md)
...
| `rnaseq_workshop_1day.html` | The R Markdown notebook's rendered HTML. Either download to open or click [here](https://github.com/chandron/IMBB-rnaseq-workshop-1day/blob/main/data/rnaseq_workshop_1day.html).|
